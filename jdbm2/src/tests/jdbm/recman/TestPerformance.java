...
public class TestPerformance extends TestCase {
    ...
    final String testfile = _TestCaseWithTestFile.newTestFile();
    ...
    protected void setUp() throws Exception {
    	 new _TestCaseWithTestFile(){}.setUp();
    };
    ...
    public void testInserts() throws Exception {
        ...
        try {
            ...
            while (true) {
                ...
                recman.insert(_TestUtil.makeRecord(rnd.nextInt(MAXSIZE),
                                               (byte) rnd.nextInt()));
                inserts++;
    ...
    private long[] makeRows() throws Exception {
        ...
        try {
            for (int i = 0; i < RECORDS; i++) {
                retval[i] = recman.insert(_TestUtil
        ...
        try {
            ...
            while (true) {
                ...
                recman.update(rowids[rnd.nextInt(RECORDS)],
                           _TestUtil.makeRecord(rnd.nextInt(MAXSIZE),
                                               (byte) rnd.nextInt()));
                updates++;
                if ((updates % 25) == 0) {
                    stop = System.currentTimeMillis();
