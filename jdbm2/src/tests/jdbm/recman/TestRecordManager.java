 ...
 */
public class TestRecordManager extends _TestCaseWithTestFile {
        ...
        throws Exception
    {
        ...
        byte[] data = _TestUtil.makeRecord(1500, (byte) 1);
        long rowid = recman.insert(data);
        assertTrue("check data1",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid), 1500, (byte) 1) );
        ...
        data = _TestUtil.makeRecord(0, (byte) 2);
        long rowid2 = recman.insert(data);
        assertEquals("old and new rowid", rowid, rowid2);
        assertTrue("check data2",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid2), 0, (byte) 2) );

        // now make the record a bit bigger
        data = _TestUtil.makeRecord(10000, (byte) 3);
        recman.update(rowid, data);
        assertTrue("check data3",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid), 10000, (byte) 3) );
        ...
        throws Exception
    {
        ...
        byte[] data1 = _TestUtil.makeRecord(150000, (byte) 1);
        long rowid1 = recman.insert(data1);
        assertTrue("check data1",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid1), 150000, (byte) 1) );

        // rollback transaction, should revert to previous state
        recman.rollback();

        // insert same 150000 byte record.
        byte[] data2 = _TestUtil.makeRecord(150000, (byte) 1);
        long rowid2 = recman.insert(data2);
        assertTrue("check data2",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid2), 150000, (byte) 1) );
        ...
        // insert a 150000 byte record.
        data1 = _TestUtil.makeRecord(150000, (byte) 2);
        rowid1 = recman.insert(data1);
        assertTrue("check data1",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid1), 150000, (byte) 2) );

        // rollback transaction, should revert to previous state
        recman.rollback();

        // insert same 150000 byte record.
        data2 = _TestUtil.makeRecord(150000, (byte) 2);
        rowid2 = recman.insert(data2);
        assertTrue("check data2",
               _TestUtil.checkRecord( (byte[]) recman.fetch(rowid2), 150000, (byte) 2) );
