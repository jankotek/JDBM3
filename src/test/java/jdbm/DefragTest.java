...
public class DefragTest extends TestCaseWithTestFile{
	...
	public void testDefrag1() throws IOException{
		...
		RecordManagerStorage m = new RecordManagerStorage(file, false);
		long loc = m.insert("123");
		m.defrag();		
		m.close();
		m = new RecordManagerStorage(file, false);
	...
	public void testDefragBtree() throws IOException{
        ...
        public void testDefragLinkedList() throws Exception{
            String file = newTestFile();
            RecordManagerStorage r = new RecordManagerStorage(file, false);
            ...
            r.close();
            r = new RecordManagerStorage(file, false);
